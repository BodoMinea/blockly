...
Blockly.Msg.com2 = "🔔 Te rog să selectezi portul USB mai întâi!" ;
Blockly.Msg.check = "Verifică...";
...
Blockly.Msg.yes = "da";
Blockly.Msg.no = "nu";
Blockly.Msg.uptodate = "💯 Versiunea este actualizată" ;
Blockly.Msg.download = "Descărcare completă, aplicația actualizată se va instala și reporni..."
// common to all blocks
Blockly.Msg.HELPURL = "https://wikifactory.com/+OttoDIY/otto-diy"; // do not translate
Blockly.Msg.pin = "pe pinul";
Blockly.Msg._AT = "la";
Blockly.Msg.AV = "înainte";
Blockly.Msg.AR = "înapoi";
Blockly.Msg.high = "HIGH"; // do not translate
Blockly.Msg.low = "LOW"; // do not translate
Blockly.Msg.right = "dreapta";
Blockly.Msg.left = "stânga";
Blockly.Msg.LetR = "dreapta & stânga";
Blockly.Msg.direction = "direcție";
Blockly.Msg.vitesse = "viteza ";
// categories (menu)
Blockly.Msg.CAT_STOCKAGE = "⊞ Stocare";
Blockly.Msg.CAT_numerique = "- Digital";
Blockly.Msg.CAT_analogique = "~ Analogic";
...
Blockly.Msg.CAT_VARIABLES = "↝ Varibile";
Blockly.Msg.CAT_FUNCTIONS = "∬ Funcții";
Blockly.Msg.CAT_ARDUINO = "∞ Structură";
Blockly.Msg.CAT_ARDUINO_IN = "⇅ Intrare/Ieșire";
Blockly.Msg.CAT_ARDUINO_OUT = "☺ Ieșire";
Blockly.Msg.CAT_ARDUINO_TIME = "◌ Timp";
Blockly.Msg.CAT_actionneur = "↻ Motoare";
Blockly.Msg.CAT_com = "☎ Comunicare";
Blockly.Msg.CAT_ARDUINO_COMM_SERIAL = "- Serial";
Blockly.Msg.CAT_ARDUINO_COMM_SOFTSERIAL = "- Emulat";
Blockly.Msg.CAT_ARDUINO_moteur="↻ Motoare DC";
Blockly.Msg.CAT_ultrason = "⇣ Senzori";
Blockly.Msg.CAT_bluetooth = "☏ Bluetooth";
Blockly.Msg.CAT_ARDUINO_matrice8x8 = "░ Matrice LED";
Blockly.Msg.CAT_DFRobot_SHIELD_LCDKEYPAD = "▀ Ecran LCD";
...
//Wireless
Blockly.Msg.esp8266_init_tooltip = "setarea conexiunii WiFi";
Blockly.Msg.esp8266_1 = "Esp 8266";
Blockly.Msg.esp8266_2 = "nume rețea";
Blockly.Msg.esp8266_3 = "parolă";
...
Blockly.Msg.OTTO9_EEPROM_TEXT= 'saveTrimsOnEEPROM';
...
Blockly.Msg.OTTO9_GETNOISE_TOOLTIP = "100 is quiet, 500 noise and more than 1000 is loud, remember to adjust the sensor sensibility physically";
