...
Blockly.Msg.INOUT_HIGH_LEVEL = "1(pornit)";
Blockly.Msg.INOUT_LOW_LEVEL = "0(oprit)";
Blockly.Msg.ARD_TYPE_CHAR = "caracter";
Blockly.Msg.ARD_TYPE_TEXT = "text";
Blockly.Msg.ARD_TYPE_BOOL = "binar";
Blockly.Msg.ARD_TYPE_SHORT = "byte";
Blockly.Msg.ARD_TYPE_NUMBER = "întreg";
Blockly.Msg.ARD_TYPE_LONG = "întreg de mari dimensiuni";
Blockly.Msg.ARD_TYPE_DECIMAL = "număr cu virgulă";
Blockly.Msg.ARD_TYPE_ARRAY = "colecție";
Blockly.Msg.ARD_TYPE_NULL = "gol";
Blockly.Msg.ARD_TYPE_UNDEF = "nedefinit";
Blockly.Msg.ARD_TYPE_VOLATILE = "întreg instabil";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "tipul lipsește din bloc";
Blockly.Msg.ARDUINO_BETWEEN = "număr aleator între";
Blockly.Msg.ARDUINO_BETWEEN_AND = "și";
Blockly.Msg.ARDUINO_VAR_DECLARE="stări";
Blockly.Msg.ARDUINO_VAR_AS = "ca";
Blockly.Msg.ARDUINO_VAR_VAL = "al valorii";
Blockly.Msg.base_def_const = "setează";
Blockly.Msg.base_define_const = "care este echivalentul";
Blockly.Msg.base_define_const_tooltip = "permit programatorului să definească o valoare";
Blockly.Msg.type = "setează o valoare ca fiind de tipul";
Blockly.Msg.ADD_COMMENT = "Adaugă un comentariu";
Blockly.Msg.CHANGE_VALUE_TITLE = "Schimbă valoarea:";
Blockly.Msg.CLEAN_UP = "Șterge blocurile";
Blockly.Msg.COLLAPSE_ALL = "Micșorează toate blocurile";
Blockly.Msg.COLLAPSE_BLOCK = "Micșorează blocul";
Blockly.Msg.CONTROLS_SWITCH_VAR_TITLE = "Cât timp";
Blockly.Msg.CONTROLS_SWITCH_MSG_DEFAULT = "implicit";
Blockly.Msg.CONTROLS_SWITCH_MSG_CASEBREAK = "este";
Blockly.Msg.CONTROLS_SWITCH_MSG_SWITCHVAR = "dacă variabila e validă";
Blockly.Msg.CONTROLS_SWITCH_MSG_DO = "execută";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "treci la următoarea iterație";
...
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "dacă nu";
...
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "execută";
Blockly.Msg.CONTROLS_REPEAT_TITLE = "repetă de %1 ori";
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Execută instrucțiuni de mai multe ori";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "Repetă de";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "Repetă cât timp";
...
Blockly.Msg.DUPLICATE_BLOCK = "Copiază";
Blockly.Msg.ENABLE_BLOCK = "Activează blocul";
Blockly.Msg.EXPAND_ALL = "Extinde blocurile";
Blockly.Msg.EXPAND_BLOCK = "Extinde blocul";
Blockly.Msg.EXTERNAL_INPUTS = "External Inputs";
Blockly.Msg.HELP = "Ajutor";
Blockly.Msg.INLINE_INPUTS = "Online Entries";
Blockly.Msg.LISTS_CREATE1 = "crează o listă";
Blockly.Msg.LISTS_CREATE2 = "cu";
...
Blockly.Msg.LISTS_GET = "elementul";
...
Blockly.Msg.LISTS_GET_INDEX_REMOVE = "șterge";
...
Blockly.Msg.TODAY = "Azi";
Blockly.Msg.UNDO = "Anulare";
Blockly.Msg.VARIABLES_AS = "Tip";
Blockly.Msg.VARIABLES_DEFAULT_NAME = "var";
Blockly.Msg.VARIABLES_GET_CREATE_SET = "Crează bloc 'setare varibilă %1 la '";
Blockly.Msg.VARIABLES_GET_TOOLTIP = "returnează valoarea acestei variabile";
Blockly.Msg.VARIABLES_SET = "pune variabile";
Blockly.Msg.VARIABLES_SET_CREATE_GET = "Crează bloc %1";
Blockly.Msg.VARIABLES_SET_TOOLTIP = "Setează valoarea variabilei";
Blockly.Msg.var_set_init = "setare variabilă";
Blockly.Msg.var_set_init_tooltip = "Declararea și setarea unei variabile de un anumit tip";
Blockly.Msg.ARDUINO_VAR_CONST = "setează constanta";
Blockly.Msg.ARDUINO_VAR_CONST_tooltip = "Declară o constantă cu tipul și valoarea dată";
...
Blockly.Msg.CONTROLS_IF_MSG_THEN = "apoi";
